...
aggregated confusion matrices, ROC data, and Fog vs Cloud comparison plots.
"""
...
# Cloud numbers just for plotting comparison (placeholder)
...
fog_rows = summary_per_model.copy()
fog_rows["Layer"] = "Fog"
