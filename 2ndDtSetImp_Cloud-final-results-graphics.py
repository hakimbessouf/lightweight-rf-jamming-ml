...
# Adapt label set to your dataset (example: AWGN / Deceptive / NoJam)
...
# The figure‑generation section from your original script can be reused unchanged,
# just ensure it uses `model_stats`, `results_df`, and `classes` as above.
